	...
	static void method852(Class117_Sub19 var0, int var1, int var2, int var3, int var4) {
		...
		if (var8 != null) {
			...
			if (GameClient.anInt3155 * -1723858213 != 2 && GameClient.anInt3155 * -1723858213 != 5) {
				...
				int var10 = 48 + Class31.player.anInt2577 * 1961555871 / 32;
				int var11 = 464 - Class31.player.anInt2567 * -184603173 / 32;
				...
				for (var12 = 0; var12 < GameClient.anInt2968 * 1159091691; var12++) {
					var5 = 2 + GameClient.anIntArray3150[var12] * 4 - Class31.player.anInt2577 * 1961555871 / 32;
					var14 = 2 + GameClient.anIntArray3127[var12] * 4 - Class31.player.anInt2567 * -184603173 / 32;
				...
				for (var12 = 0; var12 < 104; var12++) {
					for (var5 = 0; var5 < 104; var5++) {
						...
						if (var21 != null) {
							var13 = 2 + var12 * 4 - Class31.player.anInt2577 * 1961555871 / 32;
							var6 = 2 + var5 * 4 - Class31.player.anInt2567 * -184603173 / 32;
				...
				for (var12 = 0; var12 < GameClient.anInt2956 * -434472087; var12++) {
					...
					if (var18 != null && var18.method3074(-126706481)) {
						...
						if (var22 != null && var22.aBool2205 && var22.aBool2213) {
							var13 = var18.anInt2577 * 1961555871 / 32 - Class31.player.anInt2577 * 1961555871 / 32;
							var6 = var18.anInt2567 * -184603173 / 32 - Class31.player.anInt2567 * -184603173 / 32;
				...
				for (var14 = 0; var14 < var12; var14++) {
					Player var20 = GameClient.aClass117_Sub22_Sub18_Sub1_Sub2Array3041[var19[var14]];
					if (var20 != null && var20.method3074(-126706481) && !var20.aBool2883 && Class31.player != var20) {
						var6 = var20.anInt2577 * 1961555871 / 32 - Class31.player.anInt2577 * 1961555871 / 32;
						int var7 = var20.anInt2567 * -184603173 / 32 - Class31.player.anInt2567 * -184603173 / 32;
						boolean var15 = false;
						if (Class84.method1141(var20.playerName, true, 2006421320)) {
							var15 = true;
						}
						...
						for (int var17 = 0; var17 < Class29.anInt362 * -562694677; var17++) {
							if (var20.playerName.equals(Class117_Sub22_Sub18_Sub5.aClass117_Sub13Array2747[var17].aString1870)) {
								var16 = true;
								break;
							}
						}
						...
						boolean var25 = false;
						if (Class31.player.anInt2888 * 141366991 != 0 && var20.anInt2888 * 141366991 != 0 && var20.anInt2888 * 141366991 == Class31.player.anInt2888 * 141366991) {
							var25 = true;
						}
				...
				if (GameClient.anInt3095 * -949450207 != 0 && GameClient.anInt2923 * -488599663 % 20 < 10) {
					if (GameClient.anInt3095 * -949450207 == 1 && GameClient.anInt2914 * -488998301 >= 0 && GameClient.anInt2914 * -488998301 < GameClient.aClass117_Sub22_Sub18_Sub1_Sub1Array2942.length) {
						...
						if (var23 != null) {
							var13 = var23.anInt2577 * 1961555871 / 32 - Class31.player.anInt2577 * 1961555871 / 32;
							var6 = var23.anInt2567 * -184603173 / 32 - Class31.player.anInt2567 * -184603173 / 32;
					...
					if (GameClient.anInt3095 * -949450207 == 2) {
						var14 = GameClient.anInt2937 * -1455025036 - Class117_Sub22_Sub20.anInt2497 * -2116504388 + 2 - Class31.player.anInt2577 * 1961555871 / 32;
						var13 = GameClient.anInt2938 * -769503180 - Class117_Sub22_Sub19.anInt2468 * 1207777508 + 2 - Class31.player.anInt2567 * -184603173 / 32;
					...
					if (GameClient.anInt3095 * -949450207 == 10 && GameClient.anInt3167 * -2098929247 >= 0 && GameClient.anInt3167 * -2098929247 < GameClient.aClass117_Sub22_Sub18_Sub1_Sub2Array3041.length) {
						Player var24 = GameClient.aClass117_Sub22_Sub18_Sub1_Sub2Array3041[GameClient.anInt3167 * -2098929247];
						if (var24 != null) {
							var13 = var24.anInt2577 * 1961555871 / 32 - Class31.player.anInt2577 * 1961555871 / 32;
							var6 = var24.anInt2567 * -184603173 / 32 - Class31.player.anInt2567 * -184603173 / 32;
				...
				if (GameClient.anInt3153 * -140834255 != 0) {
					var14 = GameClient.anInt3153 * -563337020 + 2 - Class31.player.anInt2577 * 1961555871 / 32;
					var13 = 2 + GameClient.anInt3154 * 183343252 - Class31.player.anInt2567 * -184603173 / 32;
					Class117_Sub22_Sub16.method2860(var1, var2, var14, var13, GameClient.aClass117_Sub22_Sub17_Sub3Array2996[0], var8, -1989413251);
				}

				if (!Class31.player.aBool2883) {
