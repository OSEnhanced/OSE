...
public class Class32 {
	...
	static void method469(Player player, int var1, int var2, int var3, byte var4) {
		if (player != Class31.player) {
			if (GameClient.anInt3060 * 1223430109 < 400) {
				String var5;
				if (player.anInt2873 * -849014465 == 0) {
					var5 = player.playerName + Class83.method1139(player.anInt2874 * -1654863477, Class31.player.anInt2874 * -1654863477, 1440172605) + " " + Class39.aString479 + Class108.aString1356 + player.anInt2874 * -1654863477 + Class39.aString480;
				} else {
					var5 = player.playerName + " " + Class39.aString479 + Class108.aString1357 + player.anInt2873 * -849014465 + Class39.aString480;
				}
				int var7;
					...
					for (var7 = 7; var7 >= 0; --var7) {
						if (GameClient.aStringArray2936[var7] != null) {
							...
							if (GameClient.aStringArray2936[var7].equalsIgnoreCase(Class108.aString1352)) {
								if (GameClient.aClass36_3077 == Class36.aClass36_446 || GameClient.aClass36_3077 == Class36.aClass36_451 && player.anInt2874 * -1654863477 > Class31.player.anInt2874 * -1654863477) {
									var6 = 2000;
								}

								if (Class31.player.anInt2888 * 141366991 != 0 && player.anInt2888 * 141366991 != 0) {
									if (player.anInt2888 * 141366991 == Class31.player.anInt2888 * 141366991) {
										var6 = 2000;
									} else {
										var6 = 0;
									}
